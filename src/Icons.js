...
export const HomeFillIcon = ({ size, color, className }) => {
  return (
    <svg
      aria-label="Home"
      color="#262626"
...
export const MessageUnFillIcon = ({ size, color, className }) => {
  return (
    <svg
...
export const CreatePlusUnFillIcon = ({ size, color, className }) => {
  return (
    <svg
      aria-label="New Post"
      color="#262626"
...
export const ExploreUnFillIcon = ({ size, color, className }) => {
  return (
    <svg
...
export const HeartUnFillIcon = ({ size, color, className }) => {
  return (
    <svg
...
export const CancelIcon = ({ size, color, className }) => {
  return (
    <svg
      aria-label="Close"
      color={color}
...
export const CommentIcon = ({ size, color, className }) => {
  return (
    <svg
      aria-label="Comment"
      color="#262626"
...
export const CollectionIcon = ({ size, color, className }) => {
  return (
    <svg
      aria-label="Save"
      color="#262626"
...
export const SmileIcon = ({ size, color, className }) => {
  return (
    <svg
      aria-label="Emoji"
      color="#262626"
